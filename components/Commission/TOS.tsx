import { DISCORD_URL, TELEGRAM_URL, TWITTER_URL } from "@/constants/Socials";
...
const TOS = () => {
  return (
    <div className="w-full max-w-3xl backdrop-blur-md border thin-scrollbar border-gray-300 p-6 rounded-md shadow-lg overflow-auto h-[80vh] relative">
      ...
      <h3 className="text-2xl font-bold text-center mb-4">Terms of Service</h3>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-5">
          <li>
            Contact me via{" "}
            <a href={TWITTER_URL} className="text-blue-300 hover:underline">
              <strong>Twitter</strong>
            </a>
            ,{" "}
            <a href={TELEGRAM_URL} className="text-blue-300 hover:underline">
              <strong>Telegram</strong>
            </a>
            , or{" "}
            <a href={DISCORD_URL} className="text-blue-300 hover:underline">
          ...
          <li>
            Once it&#39;s your turn in the queue, I will notify you and request
            payment.
          </li>
          <li>
          ...
          <li>
            You can request <strong>multiple changes</strong> during the sketch
            phase.
          </li>
          <li>Once the sketch is confirmed, I will proceed with rendering.</li>
          <li>
            The final delivery time is usually <strong>within 2 months</strong>.
          </li>
          <li>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-5">
          ...
          <li>
            <strong>Major changes</strong> after sketch approval will require an
            additional fee.
          </li>
          <li>
      ...
      <section className="mb-6">
        <h4 className="text-xl font-semibold mb-2"> USAGE RIGHTS </h4>
        <ul className="list-disc pl-5">
          <li>
            I reserve the right to <strong>decline any commission</strong> at my
            discretion.
          </li>
          <li>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-5">
          ...
          <li>
            ...
            <strong>share my work publicly</strong> unless a private request is
            made.
          </li>
        </ul>
      </section>
